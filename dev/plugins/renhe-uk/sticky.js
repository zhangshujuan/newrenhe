define(function(require, exports, module) {
    ...
    UI.component('sticky', {
        ...
        boot: function() {
            ...
            UI.$doc.on('scrolling.rh.document', function() {checkscrollposition(); });
            ...
            UI.ready(function(context) {
                ...
                setTimeout(function(){
                    ...
                    UI.$("[data-rh-sticky]", context).each(function(){

                        var $ele = UI.$(this);

                        if(!$ele.data("sticky")) {
                            UI.sticky($ele, UI.Utils.options($ele.attr('data-rh-sticky')));
                        }
                    });
        ...
        init: function() {
            ...
            var wrapper  = UI.$('<div class="rh-sticky-placeholder"></div>'), boundary = this.options.boundary, boundtoparent;
            ...
            this.sticky = {
                ...
                reset         : function(force) {
                    ...
                    var finalize = function() {
                        ...
                        this.element.removeClass([this.options.animation, 'rh-animation-reverse', this.options.clsactive].join(' '));
                    ...
                    if (!force && this.options.animation && UI.support.animation) {
                        ...
                        this.element.addClass(this.options.animation+' '+'rh-animation-reverse');
                    } else {
                        finalize();
                    }
                },
