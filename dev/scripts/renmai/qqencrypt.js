define(function(require, exports, module) {
	...
	QQSimple = window.QQSimple || {};
	QQSimplept = window.QQSimplept || {};
	QQSimple.RSA = QQSimplept.RSA = function () {
	    function h(z, t) {
	        return new au(z, t)
	    }
	...
	QQSimple.Encryption = QQSimplept.Encryption = function () {
	    var hexcase = 1;
	    var b64pad = "";
	    var chrsz = 8;
	    var mode = 32;
	    ...
	    function getEncryption(password, salt, vcode, isMd5) {
	        vcode = vcode || "";
	        password = password || "";
	        var md5Pwd = isMd5 ? password : md5(password), h1 = hexchar2bin(md5Pwd), s2 = md5(h1 + salt), rsaH1 = QQSimplept.RSA.rsa_encrypt(h1), rsaH1Len = (rsaH1.length / 2).toString(16), hexVcode = TEA.strToBytes(vcode.toUpperCase(), true), vcodeLen = Number(hexVcode.length / 2).toString(16);
	    ...
	    function getRSAEncryption(password, vcode, isMd5) {
	        ...
	        var str3 = QQSimple.RSA.rsa_encrypt(str2);
	        return str3
	    }
